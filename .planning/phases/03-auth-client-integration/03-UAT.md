...
expected: |
  Visit http://localhost:3001/login. Page shows email and password input fields,
  submit button. Tailwind CSS is applied (styled form). No JavaScript errors in console.
...
reason: Requires Expo mobile app test on simulator/device
