...
Key references:
- @/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/USER-PROFILE.md" "/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/AGENTS.md"
...
```bash
BACKUP_PATH="/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/AGENTS.md
```
