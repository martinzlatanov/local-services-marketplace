...
INSTALL_JS_GLOBAL="/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
...
- Cross-project skills (`.kilo/skills/`) are out of scope — this command only touches global runtime skills roots.
