...
```
Task(
  prompt="Read /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/templates/SECURITY.md`
