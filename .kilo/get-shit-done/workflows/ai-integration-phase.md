...
<required_reading>
@/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/references/ai-frameworks.md
@/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/agents/gsd-eval-planner.md for instructions.
