...
The keys live in `.claude/settings.json` (project) or `/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.kilo/settings.json` (global) — **not** in `.planning/config.json`:
