...
The keys live in `.claude/settings.json` (project) or `/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.claude/settings.json` (global) — **not** in `.planning/config.json`:
