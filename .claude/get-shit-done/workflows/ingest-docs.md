...
```bash
INIT=$(node "/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
