...
```
Task(
  prompt="Read /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.claude/get-shit-done/templates/VALIDATION.md`
