...
- **Global scope**: `/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.claude/notes/`)
...
2. Glob `/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.claude/notes/` — works in any directory
