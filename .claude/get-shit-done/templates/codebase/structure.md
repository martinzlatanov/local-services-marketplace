...
- Usage: Reference from command with `@/Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/mzlatanov/Desktop/VS Code Projects/local-services-marketplace/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
